...
class Ui_AnaMenu(object):
    def setupUi(self, AnaMenu):
        ...
        self.pushButton_12 = QtWidgets.QPushButton(AnaMenu)
        self.pushButton_12.setGeometry(QtCore.QRect(10, 200, 91, 31))
        self.pushButton_12.setObjectName("pushButton_12")
        self.pushButton_13 = QtWidgets.QPushButton(AnaMenu)
        self.pushButton_13.setGeometry(QtCore.QRect(10, 100, 91, 31))
    ...
    def retranslateUi(self, AnaMenu):
        ...
        self.pushButton_12.setText(_translate("AnaMenu", "Teknik Servis Tablosu"))
        self.pushButton_13.setText(_translate("AnaMenu", "Gider Tablosu"))
